# -*- coding: utf-8 -*-
#
# Tag Cloud ExtBase documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 30 Mar 2016 13:51:08 +0530.
#
...
project = u'Tag Cloud ExtBase'
copyright = u'2016, Minu Thomas'
...
htmlhelp_basename = 'pits_tagclouddoc'
...
latex_documents = [
    ('Index', 'pits_tagcloud.tex', u'Tag Cloud ExtBase',
     u'Minu Thomas', 'manual'),
]
...
pdf_documents = [
    ('Index', 'pits_tagcloud', u'Tag Cloud ExtBase',
     u'Minu Thomas'),
]
...
texinfo_documents = [
    ('Index', 'pits_tagcloud', u'Tag Cloud ExtBase',
     u'Minu Thomas', 'Tag Cloud ExtBase', 'One line description of project.',
     'Miscellaneous'),
]
